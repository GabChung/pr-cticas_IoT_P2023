 ...
 ****************************************/ 
const char* UBIDOTS_TOKEN = "BBFF-wKXTqHLkdVzCsdlgUBCd37H05l05xi";  // Put here your Ubidots TOKEN 
const char* UBIDOTS_DEVICELABEL = "MQTT2"; // Device label to use 
const char* WIFI_SSID = "PILLO";      // Put here your Wi-Fi SSID 
const char* WIFI_PASS = "2368098921";      // Put here your Wi-Fi password 
